...
public class ObjectFactory {
    ...
    private final static QName _Comptes_QNAME = new QName("http://ws.example.org/", "comptes");
    private final static QName _ComptesResponse_QNAME = new QName("http://ws.example.org/", "comptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "comptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "comptesResponse")
